    ...
    return(
        <>
          <div className={styles.recipe__button_container}>
            ...
            <div className={styles.toggle__switch} onClick={() => op()}>
              <div className={styles.green__moving} onClick={handleClick} style={{transform: showDirections ? "translateX(168px)" : "", color: active ? "black" : "white"}}/>
                <button className={styles.ingredients__tab} onClick={handleClick}
        style={{ color: active ? "#26594D" : "white" }}>Ingredients</button>
                <button className={styles.directions__tab} onClick={handleClick}
        style={{ color: active ? "white" : "#26594D" }}>Directions</button>
            </div>
          </div>
          {showIngredientList && (
