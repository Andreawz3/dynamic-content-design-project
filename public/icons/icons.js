...
export function CloseIcon() {
    return (
        <>
            ...
            <path d="M11 1L1 11" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M11 11L1 1" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
        </>
    )
}
...
export function GameSolidIcon({fill="currentColor"}) {
    return (
        <>
            <svg className={styles.nav_icon} width="25" height="25" viewBox="0 0 26 25" xmlns="http://www.w3.org/2000/svg">
            <path class="st0" d="M4.8,15.7v-0.7l-0.6-0.3c-1.1-0.5-2-1.3-2.6-2.4C1,11.3,0.9,10.1,1.1,8.9c0.2-1.2,0.9-2.2,1.8-3 C3.9,5.2,5,4.7,6.3,4.8h0c0.3,0,0.5,0,0.8,0.1l0.8,0.1l0.3-0.8C8.4,3.2,9,2.4,9.8,1.9C10.6,1.3,11.5,1,12.5,1s1.9,0.3,2.7,0.9 s1.4,1.4,1.7,2.3l0.3,0.8L18,4.8c1.3-0.2,2.5,0.1,3.6,0.8c1.1,0.7,1.9,1.7,2.2,3c0.4,1.2,0.2,2.5-0.3,3.7c-0.5,1.2-1.5,2.1-2.7,2.6 l-0.6,0.3v0.7v2.3H4.8V15.7z" fill={fill} stroke={fill} strokeWidth="2"/>
            <path class="st1" d="M3.8,20.9h17.5c0,1.7-0.1,2.7-0.7,3.3C19.8,25,18.6,25,16.3,25H8.8c-2.4,0-3.5,0-4.3-0.7 C3.9,23.6,3.8,22.7,3.8,20.9z" fill={fill} />
            </svg>
        </>
    )
}