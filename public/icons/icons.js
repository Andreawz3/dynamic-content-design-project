...
export function FaveOutlineIcon() {
    return (
        <>
            <svg className={styles.icon} width="26" height="25" viewBox="0 0 26 25" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export function FaveSolidIcon() {
    return (
        <>
            <svg className={styles.icon} width="24" height="23" viewBox="0 0 24 23" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export function HomeOutlineIcon() {
    return (
        <>
            <svg className={styles.icon} width="22" height="25" viewBox="0 0 22 25" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export function NotesOutlineIcon() {
    return (
        <>
            <svg className={styles.icon} width="23" height="25" viewBox="0 0 23 25" fill="none" xmlns="http://www.w3.org/2000/svg">
