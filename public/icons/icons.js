...
export function SearchIcon() {
    return (
        <>
            ...
            <circle cx="10" cy="10" r="9" transform="matrix(-1 0 0 1 20 0)" stroke="currentColor" stroke-width="2"/>
            <line x1="1" y1="-1" x2="7" y2="-1" transform="matrix(0.707107 0.707107 0.707107 -0.707107 17 16)" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
            </svg>
        </>
    )
}
export function FilterIcon() {
    return (
        <>
            ...
            <path d="M1 8L16 8" stroke="currentColor" stroke-linecap="round"/>
            <path d="M1 14L16 14" stroke="currentColor" stroke-linecap="round"/>
            <circle cx="9" cy="2" r="2" fill="currentColor"/>
            <circle cx="5" cy="8" r="2" fill="currentColor"/>
            <circle cx="9" cy="14" r="2" fill="currentColor"/>
            <path d="M1 2L16 2" stroke="currentColor" stroke-linecap="round"/>
            </svg>
        </>
    )
}
...
export function FaveOutlineIcon() {
    return (
        <>
            ...
            <path d="M18.5 5.49997C19.8213 6.5495 19.9793 6.92014 20.5 8.49997" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
            </svg>
        </>
    )
}
...
export function NotesOutlineIcon() {
    return (
        <>
            ...
            <rect x="1.47778" y="3.08334" width="19.875" height="20.9167" rx="3" stroke="currentColor" stroke-width="2"/>
            <line x1="5.64453" y1="11.5" x2="17.1862" y2="11.5" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
            <line x1="5.64453" y1="15.6667" x2="13.0195" y2="15.6667" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
            <line x1="7.20703" y1="1" x2="7.20703" y2="4.20833" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
            <line x1="15.5403" y1="1" x2="15.5403" y2="4.20833" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
            </svg>
        </>
    )
}
