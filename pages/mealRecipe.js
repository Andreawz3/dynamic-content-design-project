        ...
        <div className={styles.recipe__container}>
          ...
          <div className={styles.ingredients__container}>
            ...
            <div className={styles.ingredients__list}>
              {recipeData[0].ingredientList.map((value, index) => {
                return (
                  <div key={index} className={styles.ingredients}>
                    <input type="checkbox" />
                    <span class="checkmark"></span>
                    <label class="container">{value.ingredientName}</label>
                    <span class="measurement">{value.measurementType}</span>
                  </div>
                );
              })}
            </div>
          ...
          <div className={styles.directions__container}>
            ...
            <div className={styles.directions__upper_text}>
              <div className={styles.serving}>
                <p>{recipeData[0].servingSize}</p>
              </div>
              <div className={styles.price}>
                <p>{recipeData[0].price}</p>
              </div>
            </div>
            <div className={styles.directions__steps}>
                {recipeData[0].directions.map((step, index) => {
                    return (
